...
import com.yxd.enmus.OrderStatusEnum;
import com.yxd.enmus.PaymentStatus;
...
import com.yxd.order.service.AddressService;
import com.yxd.pojo.*;
import com.yxd.order.service.OrderService;
import com.yxd.utils.DateUtil;
import com.yxd.vo.MerchantOrdersVO;
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderVO createOrder(SubmitOrderBO submitOrderBO) {
        ...
        newOrder.setPayStatus(PaymentStatus.WAIT_PAY.type);
...
//        newOrder.setRealPayAmount();
    ...
    public Orders queryOrder(String merchantOrderId, String merchantUserId,Integer orderStatus) {
        ...
        queryOrder.setId(merchantOrderId);
        queryOrder.setUserId(merchantUserId);
        queryOrder.setPayStatus(orderStatus);
        Orders orders = ordersMapper.selectOne(queryOrder);
        return orders;
    }
    ...
    public int orderPay(String merchantOrderId, String merchantUserId, Integer orderStatus) {
        ...
        queryOrder.setUserId(merchantUserId);
        queryOrder.setPayStatus(orderStatus);
        int index = ordersMapper.updateByPrimaryKeySelective(queryOrder);
        return index;
    }
